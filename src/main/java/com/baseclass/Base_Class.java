...
public class Base_Class {
	...
	public static WebDriver browsertype(String type) {
		if (type.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					System.getProperty("user.dir") + "\\Driver\\chromedriver_win\\chromedriver.exe");
	...
	public static void screenshot(String scName) throws IOException {
		...
		File destination = new File("C:\\Users\\jancy\\eclipse-workspace\\AdactinCucumber\\ScreenShot\\"+ scName+".png");
